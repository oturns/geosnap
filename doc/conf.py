...
#
# The full version.
version = geosnap.__version__
release = geosnap.__version__
...
latex_documents = [
    (master_doc, 'geosnapdoc.tex', u'geosnap Documentation',
     u'geosnap developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'geosnap', u'geosnap Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'geosnap', u'geosnap Documentation',
     author, 'geosnap', 'One line description of project.',
     'Miscellaneous'),
]
