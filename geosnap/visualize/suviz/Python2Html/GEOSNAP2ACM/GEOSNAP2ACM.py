...
def Adaptive_Choropleth_Mapper_viz(geosnap, param):
...
if __name__ == '__main__':
	...
	param = {
		...
		'filename_suffix': "Albertville_White_Hispanic_Asian_Mincome_2010",
		'database': "ltdb",
		'statefips': None,
		'cbsafips': "10700",
		'countyfips': None,
		...
		'label': "ltdb",                                       # variable, short_name or full_name
	}
